...
class Day11Spec extends AnyFlatSpec with Matchers {
  ...
  it should "pass the example test" in {
    solution.part1(s"test-inputs/y$year/day$day.txt") should be(374L)
  }
  ...
  behavior of "part 2"
  it should "pass the example test" in {
    solution.part2(s"test-inputs/y$year/day$day.txt", 100) should be(8410L)
  }

  it should "solve for real input" in {
    solution.part2(s"solution-inputs/y$year/day$day.txt", 1000000)
  }
}
